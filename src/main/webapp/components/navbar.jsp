...
<!--            *******************************Search bar*******************************
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#!" data-bs-toggle="modal" data-bs-target="#cart" > <i class="fa fa-cart-plus" style="font-size: 20px; margin-left: 119px"></i> <span style="font-size: 20px;" class="cart-items">(0)</span> </a>
                </li>
